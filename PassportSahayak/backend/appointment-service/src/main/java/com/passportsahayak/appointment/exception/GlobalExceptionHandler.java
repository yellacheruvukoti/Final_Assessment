package com.passportsahayak.appointment.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccessDenied(AuthorizationDeniedException ex) {
        ApiError body = new ApiError(Instant.now(), HttpStatus.FORBIDDEN.value(), "Forbidden", "You do not have permission to perform this action", null);
